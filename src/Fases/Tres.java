...
public class Tres extends Fase {
    ...
    public void carregar(String diretorioRaiz) {
        ...
        this.nave.setVelocidade(50d); // defne a velocidade da nave para 250m/s
        ...
        for (int i = 0; i <= 10; i++) {
            ...
            o.getForma().setTextura(this.texturas.getTextura("matrix")); // define a textura "malha" para a forma
