...
public class Nave2 extends Objeto {
    ...
    // costrutor completo
    public Nave2(Ponto local, Forma forma, Ponto direcao, Double velocidade, Colisor colisor) {
        this.local = local;
        this.forma = forma;
    ...
    public void movimentar(Controle c, Double timeDelta){
        ...
        if (this.intensidadeTurbo > 200d)
            this.intensidadeTurbo = 200d;
